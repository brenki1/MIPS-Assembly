...
const1: .double 1.0
const0: .double 0.0
msg1: .asciiz "Insira um numero em graus para ser calculado seu seno: "
msg2: .asciiz " \nO seno do numero inserido eh: "
aviso: .asciiz "\nOBS: quanto mais alto o valor do angulo, mais impreciso sera o calculo!\n"

.text
	l.d $f2, pi
	l.d $f6, graus
	li $s4, 3 #primeira iteracao k = 3
...
calcSen:
	li $s3, 0 #cont = 0
	l.d $f16, vAbsoluto
	l.d $f14, const3 #primeira iteracao k = 3
	l.d $f26, const2
	mov.d $f20, $f30
	loopSen:
	jal potencia
